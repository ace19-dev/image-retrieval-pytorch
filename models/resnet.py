...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50', 'BasicBlock', 'Bottleneck']
...
def resnet34(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = torch_models.resnet34()
    if pretrained:
        model = torch_models.resnet34(pretrained=True)
    return model


def resnet50(pretrained=False, root='', **kwargs):
    """Constructs a ResNet-50 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    # TODO: cutmix + resnet50 from clovaai
...
def resnet101(pretrained=False, root='', **kwargs):
    """Constructs a ResNet-101 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = torch_models.resnet101()
    if pretrained:
        model = torch_models.resnet101(pretrained=True)
    return model


# def resnet152(pretrained=False, root='', **kwargs):
